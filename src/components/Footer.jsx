const Footer = ({ genre }) => {
    return (
        <footer className="px-16 max-[780px]:px-8 max-[480px]:px-5 py-10 border-t border-[#E7E3FC3B]">
            <div className="flex max-[1050px]:flex-wrap">
                ...
                <div className="flex w-[65%] max-[1050px]:w-full max-[700px]:flex-wrap">
                    <div className="max-[700px]:w-full mr-auto">
                        ...
                        <div className="">
                            <ul className="text-[#C1C2C4] text-base grid gap-2 max-[500px]:grid-cols-2 min-[500px]:grid-flow-col min-[500px]:grid-rows-4">
                                {genre.map((item) => (
