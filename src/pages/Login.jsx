...
import PasswordInput from "../components/PasswordInput";
  ...
  return (
    <div className="form-login items-center flex flex-col bg-[#181A1CD6] bg-opacity-[84%] w-[529px] max-[1300px]:w-[480px] px-10 rounded-[16px] py-8 my-40">
        <img src="/images/logo.png" alt="" className="w-[150px]" />
        <div className="mt-8">
            <h1 className="text-center text-4xl max-[1300px]:text-3xl font-lato text-white font-normal">Masuk</h1>
            <p className="font-lato text-white text-sm font-normal mt-2">Selamat datang kembali!</p>
        </div>
        <form action="" className="w-full"> 
            ...
            <div className="flex">
                <h1 className="text-[#C1C2C4] mt-3 font-lato mr-auto">Belum punya akun? <Link to="/register" className="text-white">Daftar</Link></h1>
                <NavLink to="#" className="mt-2 font-lato text-white">Lupa kata sandi?</NavLink>
            </div>
