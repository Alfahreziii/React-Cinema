...
const RegisterPage = () => {
    ...
    return (
      <div className="items-center flex flex-col bg-[#181A1CD6] bg-opacity-[84%] w-[529px] max-[1300px]:w-[480px] px-10 rounded-[16px] py-8 my-40">
        ...
        <form action="" className="w-full">
            ...
            <h1 className="text-[#C1C2C4] mt-3 font-lato mr-auto">Sudah punya akun? <Link to="/" class="text-white">Masuk</Link></h1>
